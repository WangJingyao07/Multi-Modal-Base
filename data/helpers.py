...
def collate_fn(batch, args):
    ...
    img_tensor = None
    if args.model in ["mml_vt", "concatbert", "mmbt","latefusion",'tmc']:
    # if args.model in ["img",'mutual']:
...
def get_data_loaders(args):
    tokenizer = (
        ...
        BertTokenizer.from_pretrained(args.bert_model, do_lower_case=True).tokenize
        if args.model in ["mml_vt","latefusion",'tmc']
        else str.split
    )
