...
def model_forward(i_epoch, model, args, criterion, batch):
    ...
    av_loss = nn.CrossEntropyLoss()(audio_visual_logits, tgt)
    
    return av_loss, audio_clf_loss, visaul_loss, audio_logits, visual_logits, tgt
...
def train(args):
    ...
    for i_epoch in range(start_epoch, args.max_epochs):
        ...
        for batch in tqdm(train_loader, total=len(train_loader)):
            ...
            loss_value_mm, loss_value_v, loss_value_a = [], [], []
            cos_audio, cos_visual = [], []
            ...
            loss = av_loss + audio_clf_loss + visaul_loss
            loss.backward()
