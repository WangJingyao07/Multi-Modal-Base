...
def get_args(parser):
    ...
    parser.add_argument("--data_path", type=str, default="/data/users/wjy/data/Trian_datasets/Affections")
    ...
    parser.add_argument("--name", type=str, default="mml_avt")
    parser.add_argument("--num_image_embeds", type=int, default=3)
    parser.add_argument("--patience", type=int, default=10)
    parser.add_argument("--savedir", type=str, default="./saved/MVSA_")
...
# 
            ...
            preds.append(pred)
            preds_txt.append(pred_audio)
            preds_img.append(pred_visual)
...
def model_forward(i_epoch, model, args, criterion, batch):
    ...
    logits_a, logits_v = model(txt, mask, segment, img)


    return logits_a, logits_v, tgt
...
def train(args):
    ...
    # print(len(train_loader), len(val_loader), len(test_loaders))
