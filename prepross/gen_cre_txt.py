...
video_data_dir = "/data/users/wjy/data/MLAUA/CRE/VideoFlash"
audio_data_dir = "/data/users/wjy/data/MLAUA/CRE/AudioWAV"
...
for filename in tqdm(train_files):
    ...
    # print(source_v_path, target_v_path)
    # print(source_a_path, target_a_path)
