...
test_audio_dir = '/data/users/wjy/data/IEMOCAP/subaudio/'

all_test_files = os.listdir('/data/users/wjy/data/IEMOCAP/subvideo')
...
for i, item in enumerate(all_test_files):
    if i % 500 == 0:
        ...
        print('*******************************************')
    mp4_filename = os.path.join('/data/users/wjy/data/IEMOCAP/subvideo/', item)
